...
const Footer = () => {
  return (
    <div className="bg-gray-800">
      <div className="flex items-center justify-between p-20 max-sm:p-5 max-sm:flex-col max-lg:p-5">
        <div className="w-3/4 p-10 max-sm:w-full">
          <h1 className="text-4xl text-white main-heading">Smurfs Football Academy</h1>
          <p className="text-white text-sm mt-4 w-1/2 max-sm:w-full">
        ...
        <div className="w-1/4 max-sm:w-full max-sm:p-10">
