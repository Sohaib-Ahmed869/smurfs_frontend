...
const AdminSiderbar = () => {
  ...
  return (
    <div className={`{show ? "overflow-hidden" : ""}`}>
      <a
        className="text-white bg-accent hover:bg-accent focus:ring-4 font-medium text-sm px-5 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800 cursor-pointer absolute top-0 right-3 rounded-br-lg rounded-bl-lg border-2"
        type="button"
      ...
      <div
        ...
        className="fixed z-50 top-0 left-0 w-64 h-screen p-4 overflow-y-auto transition-transform -translate-x-full shadow-2xl border-r-4 border-gray-600 bg-accent"
        tabIndex="-1"
        ...
        <div className="py-4 overflow-y-auto">
          <ul className="space-y-2 font-medium">
            ...
            {/* <li>
              ...
              >
                <CiMoneyBill className="w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white" />
            ...
            <li>
              ...
              >
                <RiFootballFill className="w-5 h-5 text-white transition duration-75 dark:text-white group-hover:text-gray-900 dark:group-hover:text-white" />
            ...
            <li>
              ...
              >
                <svg
                  className="w-5 h-5 text-white dark:text-white group-hover:text-gray-900 dark:group-hover:text-white"
                  aria-hidden="true"
                  xmlns="http://www.w3.org/2000/svg"
                  fill="currentColor"
                  viewBox="0 0 20 20"
